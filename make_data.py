...
def main():
    ...
    load_and_cache_examples(configs.domain_names[0], configs.train_file[0], tokenizer, evaluate=False,
                            output_examples=True)
    load_and_cache_examples(configs.domain_names[1], configs.train_file[1], tokenizer, evaluate=False,
                            output_examples=True)
